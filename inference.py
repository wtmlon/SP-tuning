...
data_dir = '/apdcephfs/private_shaotiancai/datasets/data/k-shot/{}/16-13/'.format(task_name)
output_dir = '/apdcephfs/private_shaotiancai/code/model/DART_copy/output/{}/{}/16-13/'.format(task_name, prompt_type)
dev_res_file = '/apdcephfs/private_shaotiancai/code/model/DART_copy/output/visual/{}-{}-dev.eval'.format(task_name, prompt_type)
test_res_file = '/apdcephfs/private_shaotiancai/code/model/DART_copy/output/visual/{}-{}-test.eval'.format(task_name, prompt_type)
