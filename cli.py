...
parser.add_argument("--early_stop_epochs", default=5, type=int,   # 3000
...
parser.add_argument("--x_input", type=str,
                    choices=['replace', 'mix', 'mul'], help="Whether use input to generate prompt")
parser.add_argument("--warmup", action='store_true', default=False,
                    help="Whether warmup before using input to generate prompt")
